...
function contadorEntradas(title, dateEvent) {
    ...
    if (Storage !== "undefined") {
        ...
        switch (title) {
            case 'Seminario permanente':
                localStorage.setItem("Entrada1Titulo", title);
                localStorage.setItem("Entrada1Fecha", dateEvent);
                break;
            case 'Talleres sedajazz':
                localStorage.setItem("Entrada2Titulo", title);
                localStorage.setItem("Entrada2Fecha", dateEvent);
                break;
            case 'Curso blues Bejar':
                localStorage.setItem("Entrada3Titulo", title);
                localStorage.setItem("Entrada3Fecha", dateEvent);
                break;
            case 'Jazz musica moderna':
                localStorage.setItem("Entrada4Titulo", title);
                localStorage.setItem("Entrada4Fecha", dateEvent);
                break;
            case 'FiJazz':
                localStorage.setItem("Entrada5Titulo", title);
                localStorage.setItem("Entrada5Fecha", dateEvent);
                break;
            case 'Curso de improvisación':
                localStorage.setItem("Entrada6Titulo", title);
                localStorage.setItem("Entrada6Fecha", dateEvent);
                break;
        }
